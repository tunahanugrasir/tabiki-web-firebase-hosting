...
import 'package:tabiki_web/presentation/pages/be_a_producer/desktop/widgets/timeline_step.dart';
...
class TabletLayoutBeAProducerView extends StatefulWidget {
  const TabletLayoutBeAProducerView({super.key});

  @override
  State<TabletLayoutBeAProducerView> createState() => _TabletLayoutBeAProducerViewState();
}

class _TabletLayoutBeAProducerViewState extends State<TabletLayoutBeAProducerView> {
        ...
        child: Column(
          children: [
            ...
            FadeInDown(
              ...
              duration: const Duration(milliseconds: 1200),
              child: Text(
                "Ürünlerinizi değerinin altında satmaktan bıktınız mı? Adil fiyatlarla, doğrudan tüketiciye ulaşarak emeğinizin gerçek karşılığını alın.",
                textAlign: TextAlign.center,
                style: GoogleFonts.merriweather(
