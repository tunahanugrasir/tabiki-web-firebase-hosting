...
import 'package:kartal/kartal.dart';
  ...
  final List<Map<String, dynamic>> _faqCategories = [
    ...
    },
    {
      ...
      'items': [
        {
          'question': 'Teslimat sırasında ürünlerim hasarlı çıkarsa ne yapmalıyım?',
          'answer':
              'Teslimat sırasında bir ürünün hasarlı olduğunu fark ederseniz, teslimat görevlisine bildirerek değişim talep edebilirsiniz. Ayrıca bizimle iletişime geçerek durumu bildirmeniz yeterlidir.',
        },
        {
          'question': 'Ürün iadesi yapabilir miyim?',
          'answer': 'Evet, kullanılmamış ve ambalajı bozulmamış ürünleri teslimat tarihinden itibaren 24 saat içinde iade edebilirsiniz.',
        },
      ],
    },
    {
...
Widget tabletBuildFAQSection(BuildContext context) {
    return Container(
